...
namespace BizfreeApp.Migrations
{
    ...
    [Migration("20250717054357_CompanyRoleTableCreate")]
    partial class CompanyRoleTableCreate
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BizfreeApp.Models.CompanyRole", b =>
                {
                    ...
                    b.Property<bool?>("DefaultPermission")
                        .HasColumnType("boolean")
                    ...
                    b.HasIndex(new[] { "CompanyId", "RoleId" }, "uq_company_roles_company_id_role_id")
                        .IsUnique();
